...
def test_nome_usuario_logado_disponivel(resp_home_com_usuario_logado, usuario_logado):
    assert_not_contains(resp_home_com_usuario_logado, usuario_logado.first_name)


def test_botao_de_logout_disponivel(resp_home_com_usuario_logado):
    assert_not_contains(resp_home_com_usuario_logado, reverse('logout'))
